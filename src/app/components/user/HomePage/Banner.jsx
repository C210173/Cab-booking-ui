...
const Banner = () => {
  return (
    <div className="h-[90vh]">
      ...
      <div className="banner-mini_container px-36">
        ...
        <div className="bg-white pt-5">
          <div className="flex items-center justify-around">
            ...
            <div
              onClick={() => router.push("/")}
              className="search-olaCab-button cursor-pointer flex items-center py-4 px-14 border border-slate-900 justify-around"
            >
